...
function initScrollAnimations() {
    ...
    const elementsToObserve = document.querySelectorAll(
        '.reveal-text, .reveal-up, .skill-card, .exp-card, .project-card, .contact-form, .contact-info, .about-text, .cp-content'
    );
...
if (!window.IntersectionObserver) {
    ...
    // Fallback: Add reveal class to all elements immediately
    const elementsToReveal = document.querySelectorAll('.reveal-text, .reveal-up');
